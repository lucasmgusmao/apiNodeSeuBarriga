...
exports.seed = (knex) => {
  ...
  return knex('transactions').del()
    ...
    .then(() => knex('users').insert([
      {id: 10000, name: 'User #1', email: 'user1@mail.com', senha: '$2a$10$rJhUWN9qNPkjfd0N9vH.tu92NRj017Um4CrI9NsgY4FOmqb9ggqG2'},
      {id: 10001, name: 'User #2', email: 'user2@mail.com', senha: '$2a$10$rJhUWN9qNPkjfd0N9vH.tu92NRj017Um4CrI9NsgY4FOmqb9ggqG2'}      
    ]))
